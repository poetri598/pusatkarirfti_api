...
export const CreateUserOrganizationExperiences = controllerHandler(async (req, res) => {
  ...
  if (!user_id || !experiences) {
    return fail(res, "user_id dan experiences diperlukan", 400);
  }
  ...
  return success(res, "Pengalaman organisasi berhasil ditambahkan", result, 201);
});
...
export const DeleteUserOrganizationExperiencesByUsername = controllerHandler(async (req, res) => {
  ...
  return success(res, `Berhasil menghapus seluruh data berdasarkan username: ${username}`, result, 200);
});
...
export const UpdateUserOrganizationExperiencesByUsername = controllerHandler(async (req, res) => {
  ...
  return success(res, `Berhasil memperbarui seluruh pengalaman organisasi untuk username: ${username}`, result, 200);
});
